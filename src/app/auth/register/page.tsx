...
import { MapPin, Lock, Mail, User, ArrowRight, Loader2 } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (res?.error) {
          setError('Failed to authenticate automatically. Please sign in manually.');
        } else {
    ...
    <div className="relative min-h-screen bg-slate-950 flex items-center justify-center p-6 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md animate-slide-up">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Join us today! Build your local footprint.</p>
        </div>
